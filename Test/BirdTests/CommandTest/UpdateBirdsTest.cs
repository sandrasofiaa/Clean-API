...
//        {
//            // Arrange
//            var existingBirdId = _mockDatabase.Birds.First().AnimalId; // Assuming the first bird in the list is the one you want to update
...
//            Assert.That(updatedBird.AnimalId, Is.EqualTo(existingBirdId)); // Ensure the ID of the updated bird matches the provided ID
